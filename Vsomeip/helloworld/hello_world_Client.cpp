...
#define Client_Instance_ID 0x0001 

std::shared_ptr<vsomeip::runtime> C_runtime;
std::shared_ptr<vsomeip::application> C_application;
...
int main(){
    ...
    C_application = C_runtime->create_application();
    C_application->init();
